    ...
    function formulario() {
       ...
       // --------------------------------------------------------------------------------------------------
        ...
        echo '<table id="tablaReporte" class="display" cellspacing="0" width="100%"> '
                 . '<thead style="display: table-row-group"><tr><th>'."NOMBRE".'</th><th>'."DESCRIPCIÓN".'</th> <th>'."FECHA INICIO".'</th> <th>'."FECHA FIN".'</th> <th>'."FECHA PRELIQUIDACIÓN".'</th><th>'."VER DETALLE".'</th><th>'."ESTADO".'</th></tr></thead>
