		...
		echo $this->miFormulario->formulario ( $atributos );
		{
			...
			
			{
				...
				if ($_REQUEST ['mensaje'] == 'inserto') {
					...
					$mensaje = "Registro liquidación Satisfactorio <br> Nombre: <h4>" . $_REQUEST ['nombreRegistro'] . "</h4>".
					"<br>No. Preliquidación: <h4>" . $_REQUEST ['estadoRegistro'] . "</h4>".
					"<br>Fecha Registro: " . date ( 'Y-m-d' );
					$mensaje .= "<br> Nueva liquidación Registrada!";
					// ---------------- CONTROL: Cuadro de Texto --------------------------------------------------------
				...
				if ($_REQUEST ['mensaje'] == 'modifico') {
					...
					$mensaje = "Modificación estado liquidación Satisfactorio <br> Código: <h4>" . $_REQUEST ['nombreRegistro'] . "</h4>".
					"<br>Estado: <h4>" . $_REQUEST ['codigoRegistro'] . "</h4>".
					"<br>Fecha Registro: " . date ( 'Y-m-d' );
					$mensaje .= "<br> Modificada liquidación!";
					// ---------------- CONTROL: Cuadro de Texto --------------------------------------------------------
					$esteCampo = 'mensajeRegistro';
					$atributos ['id'] = $esteCampo;
					$atributos ['tipo'] = 'success';
