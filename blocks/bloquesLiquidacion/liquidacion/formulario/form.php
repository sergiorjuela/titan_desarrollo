...
class Formulario {
	...
	function formulario() {
		...
		$atributos ['tipoEtiqueta'] = 'inicio';
		$atributos ["leyenda"] = "GESTIÓN DE LIQUIDACIÓN";
		...
		$atributos ['cadena_sql'] = $this->miSql->getCadenaSql ( "buscarRegistros" );
		$matrizItems = $primerRecursoDB->ejecutarAcceso ( $atributos ['cadena_sql'], "busqueda" );
		$longitud = count ( $matrizItems );
		
		$i = 0;
		
		echo '<table id="tablaReporte" class="display" cellspacing="0" width="100%"> ' . '<thead style="display: table-row-group"><tr><th>' . "NOMBRE" . '</th><th>' . "DESCRIPCIÓN" . '</th> <th>' . "FECHA INICIAL" . '</th> <th>' . "FECHA FINAL" . '</th><th>' . "ESTADO DE PAGO" . '</th><th>' . "VER DETALLE" . '</th><th>' . "MODIFICAR" . '</th></tr></thead>
