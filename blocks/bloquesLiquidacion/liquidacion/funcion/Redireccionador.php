	...
	public static function redireccionar($opcion, $valor = "") {
		...
		switch ($opcion) {
			...
			case "verdetalle" :
				...
				$variable .= '&variable=' . $valor;
				break;
			case "verdetallePersona" :
				$variable = 'pagina=' . $miPaginaActual;
				$variable .= "&opcion=verdetallePersona";
				$variable .= '&variable=' . $valor;
				break;
			case "verdetalleConceptos" :
				$variable = 'pagina=' . $miPaginaActual;
				$variable .= "&opcion=verdetalleConceptos";
				$variable .= '&variable=' . $valor;
				break;
			case "inserto" :
				$variable = 'pagina=' . $miPaginaActual;
				...
				$variable .= "&estadoRegistro=" . $valor ['preliquidacion'];
				break;
			case "noInserto" :
				$variable = 'pagina=' . $miPaginaActual;
				$variable .= "&opcion=mensaje";
			...
			case "modifico" :
				...
				$variable .= "&opcion=mensaje";
				$variable .= "&nombreRegistro=" . $valor ['codigo'];
				$variable .= "&codigoRegistro=" . $valor ['estado'];
