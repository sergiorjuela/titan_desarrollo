...
class Formulario {
    ...
    function formulario() {
        ...
        */
		...
		$_identificadorplantilla = $_REQUEST['variable'];//Codigo Unico que identifica el Concepto
		$atributos['cadena_sql'] = $this->miSql->getCadenaSql("consultarEstadoPlantilla",$_identificadorplantilla);
       ...
       echo '<h3>Se realizará el cambio de estado del registro:</h3>';
       echo '<h3>Nombre y Estado Actual:</h3>';
        ...
        */
        ...
        $valorCodificado .= "&id_plantilla=" . $_identificadorplantilla;
        $valorCodificado .= "&estadoActual=" . $opcion;
