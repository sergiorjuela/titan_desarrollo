...
$cadenaReporte = $this->sql->getCadenaSql ('obtenerInformaciondelReporte',$_REQUEST['tipoReporte']);
$informacionReporte = $primerRecursoDB->ejecutarAcceso( $cadenaReporte, "busqueda" );
$cadenaPersona = $this->sql->getCadenaSql ('obtenerInformacionPersona',$_REQUEST['documento']);
$informacionPersona = $primerRecursoDB->ejecutarAcceso( $cadenaReporte, "busqueda" );
...
mso-bidi-font-size:11.0pt;line-height:107%'>El usuario  , con
identificación , se ha registrado con éxito. A continuación se relaciona
...
<table align='center' class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:1'>
  ...
  <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><b style='mso-bidi-font-weight:normal'><span style='font-size:12.0pt;
  mso-bidi-font-size:11.0pt'>Nombres Juan Perez </span></b></p>
  </td>
