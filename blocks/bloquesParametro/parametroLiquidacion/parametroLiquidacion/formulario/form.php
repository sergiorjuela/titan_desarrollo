	...
	echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );
       ...
       $longitud = count($matrizItems);
        ...
        echo '<table id="tablaReporte" class="display" cellspacing="0" width="100%"> '
                 . '<thead style="display: table-row-group"><tr><th>'."NOMBRE".'</th> <th>'."SIMBOLO".'</th> <th>'."DESCRIPCION".'</th> <th>'."VALOR".'</th><th>'."ESTADO".'</th><th>'."VER DETALLE".'</th><th>'."MODIFICAR".'</th><th>'."CAMBIAR ESTADO".'</th></tr></thead>
