...
class Formulario {
	...
	echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );
        ...
        $atributos ['validar'] = 'required,custom[onlyNumberSp],minSize[5],maxSize[15]';
        ...
        $atributos ['obligatorio'] = true;
        $atributos ['etiquetaObligatorio'] = true;
        $atributos ['validar'] = 'required,maxSize[25],custom[onlyLetterSp]';
        ...
        $atributos ['obligatorio'] = false;
        $atributos ['etiquetaObligatorio'] = false;
        $atributos ['validar'] = 'maxSize[40], custom[onlyLetterSp]';
